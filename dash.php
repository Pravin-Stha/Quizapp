...
<div class="row">
<div class="col-lg-6">
<span class="logo">Welcome To Admin Page!</span></div>
<?php
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="dash.php?q=0"><b>Quiz Application</b></a>
    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="" width=100 height=100 alt="Quiz App" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Team Quiz</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+977 9841650637</h4>
		<h4 style="font-family:'typo' ">Quizapp@gmail.com</h4>
		<h4 style="font-family:'typo' ">Deerwalk  of Technology,Ktm</h4></div></div>
		</p>
      </div>
